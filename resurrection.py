...
Until Death says 'This corridor is an offshoot of the Maze of Memories. The memories of the dead exist here - in theory, here contains the memories we need.'""", "0"), #0
	(
"""Death leads the way down the corridor to a dead end. 'Let me just...' and with one sweep of an arm, a word appears on the wall.

'Shcaneg vreen arw. It's a prhase that got jumbled up. If we can solve it, the wall will open. Get to it, assistant. We don't have eternity. Well, we do, but I have better places to spend it in rather than here.' Death mutters impatiently.""", "1"), #1
	(
...
'To the next destination - the Labyrith of Flesh.' A portal opens, and you follow Death through it to the next area.""", "4"), #4
	(
"""Out of the portal you and Death step, straight into a place that seems to made up of quivering masses of flesh.

'Distasteful, isn't it? The first Death took the idea of a realm for the flesh of the dead a little too literally. Watch your step, the whole place is alive.' With that said, Death walks on forward to what looks like a massive artery - big enough for a bus to go through with room to spare.""", "5"), #5
	(
...
It stumbles towards you both, arms outstretched, moaning 'idlmde. idlmde. idlmde!' Death steps forward, brandishing the iconic scythe. 'Work our the true word. Quickly now!'""", "12"), #12
	(
