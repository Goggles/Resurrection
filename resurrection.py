...
Until Death says 'This corridor is an offshoot of the Maze of Memories. The memories of the dead exist here - in theory, here contains the memories we need.'""", #0
	
"""Death leads the way down the corridor to a dead end. 'Let me just...' and with one sweep of an arm, a word appears on the wall.

'Shcaneg vreen arw. It's a prhase that got jumbled up. If we can solve it, the wall will open. Get to it, assistant. We don't have eternity. Well, we do, but I have better places to spend it in rather than here.' Death mutters impatiently.""", #1
	
"""The next section of corridor is revealed, the dust beyond unsettled by the collapse of the wall.""", #2
	
"""Again, you happen upon a dead end. Another sweep of an arm, and another jumbled word appears on the wall. 'ro lhle naheev. Another jumbled word. You know what to do, assistant. """, #3
...
'To the next destination - the Labyrith of Flesh.' A portal opens, and you follow Death through it to the next area.""", #4
	
"""Out of the portal you and Death step, straight into a place that seems to made up of quivering masses of flesh.

'Distasteful, isn't it? The first Death took the idea of a realm for the flesh of the dead a little too literally. Watch your step, the whole place is alive.' With that said, Death walks on forward to what looks like a massive artery - big enough for a bus to go through with room to spare.""", #5
	
"""You both stop before a membrane blocking the corridor. A mess of characters are carved into the thin barrier. 'taalfyti. Yet another anagram. Let us hope it is the last...'""", #6
...
Some of the mist rises and forms into the shape of a heart - which starts moving around in a jerky fashion. Faintly, you hear a voice saying 'ghhi' repeatedly. 'Say the actual word! It's another puzzle! Say the true word and it will be stunned!' Death is now holding a butterfly net in one hand, intently watching the fast-moving mist-heart.""", #8
	
"""The mist-heart freezes as you utter the right word. Death captures it quickly with the butterfly net. 'One down. Let us find the others.' You both continue down the corridor, waiting for another mist-heart to appear.""", #9
	
"""'wlo. wlo. wlo.' The voice echos around you both, as another mist-heart is formed. 'Stun it, assistant!' Death readies the butterfly net again.""", #10
...
It stumbles towards you both, arms outstretched, moaning 'idlmde. idlmde. idlmde!' Death steps forward, brandishing the iconic scythe. 'Work our the true word. Quickly now!'""", #12
	
"""As you utter the true word, the figure's right arm breaks away and forms into a mist-heart. Death sweeps forward and catches it, dodging a lunging attack from the mist-figure. 'klbco...klbco...' the mist-monster intones""", #13
	
"""The left arm of the mist-figure breaks off and forms into a mist-heart - like the previous limb. The figure howls in pain - 'ujpm, ujpm, ujpm!' 'Say the true word, then we get the final piece!' Death yells while capturing the mist-heart.""", #14
	
"""It freezes, then reforms into a giant mist-heart. Death grabs it and stashes it away somewhere in his vast robes. 'We have everything. We can now resurrect this person and send them back.' And with that, Death warps both of you away.""", #15
